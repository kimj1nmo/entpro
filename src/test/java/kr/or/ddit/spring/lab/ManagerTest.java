...
import kr.or.ddit.demo.collection.Manager;
import kr.or.ddit.demo.collection.People;
import kr.or.ddit.demo.collection.Student;
...
//				new String[]{"com/example/spring/lab/beans-aspect.xml"});
		...
		ApplicationContext context = new ClassPathXmlApplicationContext(
				new String[]{"kr/or/ddit/spring/lab/beans-aspect2.xml"});
