...
<div class="content-wrapper" style="background-color: white;">
	...
	<div class="content-header">
			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active"><a href="javascript:location.reload()">설문 작성</a></li>
				 </ol>
				</div>
				<!-- /.col -->
			</div>
		...
		<div class="container-fluid">
		<h2 class="pageTitle">설문 작성</h2><button type="button" id="previewBtn" style="border:none; color:grey; background-color:white;">시연용</button>
			<div class="row">
				<div class="col-12">
				<!-- /.card-header -->
	              ...
	              <!-- form start -->
	                ...
	                <div class="card-body">
	                  ...
	                  <div class="form-group">
	                    ...
	                    <input type="text" class="surveyExplanation form-control" id="surveyTitle2" placeholder="설명 입력">
	                  </div>
	                  <!-- 날짜와 시간 선택 -->
	                  <div class="form-group">
	                  <label>설문 기간</label>
...
<!-- 	                    <label for="question">질문</label> -->
	                    ...
	                    <input type="text" class="questionTitle form-control" id="questionTitle" placeholder="질문 입력">
	                  </div>
	                  <div class="form-group">
<!-- 	                    <label for="questionExplanation">설명</label> -->
	                    <input type="text" class="questionExplanation form-control" id="questionExplanation" placeholder="설명 입력">
	                  </div>
				    ...
				    <div class="card-body">
				        <div class="form-group option-group">
					            <label for="questionItem">항목</label>
					             <div class="item-wrap">
					              <input type="text" class="questionItem form-control" id="questionItem" placeholder="항목">
                    ...
                    <div class="custom-control custom-switch" style="margin-left: 20px; margin-bottom: 10px;">
                      <input type="checkbox" class="custom-control-input" id="requiredAnswer${questionVO.srvyQstnNo}">
                      <label class="custom-control-label" for="requiredAnswer${questionVO.srvyQstnNo}">답변 필수</label>
                    </div>
...
$("#previewBtn").on("click", function(){
	$("#surveyTitle").val("'디지털 멤버십’ 설문조사");
	$("#surveyTitle2").val("디지털 멤버십 혜택에 대한 설문 이벤트에 참여하고 200 젤리 받아가세요!");
	// 날짜도 되긴 하는데 꼭 직접 넣어보시고 사용 바랍니다
	$("#questionTitle").val("내가 가장 선호하는 디지털 멤버십 혜택은?");
	$("#questionExplanation").val("나에게 가장 잘 맞는 디지털 멤버십 혜택 1개를 골라 투표를 완료해주세요.");
	$("#questionItem").val("멤버십 전용 콘텐츠 제공");
});
</script>
