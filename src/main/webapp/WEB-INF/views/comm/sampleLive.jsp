					...
					<div class="aaa">
						<div class="leftA">
							...
							<img id="artistNo" class="img-circle img-bordered-sm"
								...
								src="${LiveVO.fileGroupVO.fileDetailVOList[0].fileSaveLocate}"
								alt="" title=""> <a
								href="http://localhost/comm/artistProfile?artistNo=5#"
								style="font-weight: bold;" id="artistName">${LiveVO.commRegNick} </a>
						</div>
						<div class="rightA">
