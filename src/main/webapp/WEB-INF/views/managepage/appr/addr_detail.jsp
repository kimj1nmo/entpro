...
<table border="1px solid #ddd" class="appr_table" style="width: 90vh;">
			  ...
			  <tr>
				<td class="stamp">
					<div id="stampImg"><img src="/resources/upload/2025/01/14/7511d75a-e04f-4039-a0f8-7abaf0fdb73d_승인도장.jpg" alt="잉"width="50px" height="50px"></div>
					<p class="app_date">2025-02-04</p>
				</td>
				<td class="stamp">
					<div id="stampImg"></div>
		...
		<p class="app_ttl">${apprDocVO.atrzDocNm }</p>
<!-- 		<textarea rows="6" class="app_area" class="app_content"> -->
		<pre>${apprDocVO.atrzDocCn }</pre><!-- </textarea> -->
